...
```{r name=inputs_and_load_emapper, include=FALSE}
# --- Inputs ---
...
```{r name=build_term2gene, include=FALSE}
...
```{r name=go_split_bp_mf_cc, include=FALSE}
...
```{r name=helpers_enrichment, include=FALSE}
...
```{r name=precompute_results, include=FALSE}
...
## Enrichment Analysis — Final Report (Shiny)

```{r name=shiny_ui, echo=FALSE}
sidebarLayout(
  sidebarPanel(
    selectInput(
      "contrast",
...
```{r name=shiny_server, echo=FALSE}
